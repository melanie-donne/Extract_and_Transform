...
Original file is located at
    https://colab.research.google.com/drive/1aXQPVJUYBQjh69iYJUyPqLnUANKaonlO
"""
...
def extract():
    ...
    column_names = amendes.columns

    # Obtention des types de données des colonnes
    column_types = [str(field.dataType) for field in amendes.schema.fields]
...
def extract():
    ...
    amendes = pd.read_csv("amendes.csv")

    # Afficher le schéma
    print("Schéma de amendes :")
    print(amendes.dtypes)

    # Afficher les premières lignes du DataFrame
    print("Premières lignes de amendes :")
    print(amendes.head())